...
public class AnaMenuFragment extends Fragment implements View.OnClickListener {
    ...
    private ImageView bim1,bim2,bim3,sok1,sok2,sok3,a1,a2,a3;
    ...
    private void init(View v){
        bim1 = (ImageView) v.findViewById(R.id.img_bim1);
        bim2 = (ImageView) v.findViewById(R.id.img_bim2);
        bim3 = (ImageView) v.findViewById(R.id.img_bim3);

        sok1 = (ImageView) v.findViewById(R.id.img_sok1);
        sok2 = (ImageView) v.findViewById(R.id.img_sok2);
        sok3 = (ImageView) v.findViewById(R.id.img_sok3);

        a1 = (ImageView) v.findViewById(R.id.img_A101_1);
        a2 = (ImageView) v.findViewById(R.id.img_A101_2);
        a3 = (ImageView) v.findViewById(R.id.img_A101_3);
    ...
    class playPreMovie extends AsyncTask {
        ...
        String str,link;
        ImageView v;
        public playPreMovie(String str,String link ,ImageView v) {
            this.str = str;
            this.link = link;
            this.v = v;
        }
